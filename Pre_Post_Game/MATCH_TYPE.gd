	...
	if Input.is_action_just_pressed("RIGHT"):
		...
		match pointer_index:
			0: # AI vs Player
				...
				SFX.play()
				Global.Player_One["User"] = "Player"
				Global.Player_Two["User"] = "AI"
			...
			1: # Player vs Player
				...
				SFX.play()
				Global.Player_One["User"] = "Player"
				Global.Player_Two["User"] = "Player"
				get_tree().change_scene_to_file("res://scenes/Pre_Post_Game/CharacterSelect.tscn")
			2: # AI vs AI
				SFX.stream = load("res://assets/audio/SFX/Capture1.wav")
				SFX.play()
				Global.Player_One["User"] = "AI"
				Global.Player_Two["User"] = "AI"
				get_tree().change_scene_to_file("res://scenes/Pre_Post_Game/CharacterSelect.tscn")
				
			3: # Back
				SFX.stream = load("res://assets/audio/SFX/walen.wav")
				SFX.play()
